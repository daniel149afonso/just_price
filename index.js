...
function displayInstruction(chosenNumber){
    ...
    chosenNumber = parseInt(chosenNumber);//convert to int
        if(chosenNumber>rdn){
            ...
            instruction.textContent = "#" + count + "( " + chosenNumber + " ) C'est moins !";
            instruction.className = "instruction moins";
        }
        else if(chosenNumber<rdn){
            //ajoute la class plus
            instruction.textContent = "#" + count + "( " + chosenNumber + " ) C'est plus !";
            instruction.className = "instruction plus";
        }
        else{
            instruction.textContent = "#" + count + "( " + chosenNumber + " ) Félicitations vous avez trouvé le juste prix !";
